...
namespace LogicalOperatores
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Combining && and ||
            //when combining conditions it is very important that you 
            //combine conditions in a way that matches your desired testing
            //To do this use (...)
            //conditions within (...) are done first
            // T || T && T
            // F || F && T
            // T || F && T ...
            ...
            {
                Console.WriteLine($"{number} is not divisible by 2 or 3 and {number} is not less than 10");
            }
