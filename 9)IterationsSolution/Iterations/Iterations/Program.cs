...
namespace Iterations
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //pre-test loop structure (a.k.a(Also known as) Do-While structure)
            //string inputTemp;
            //int aNumber;
            ...
            //    {
            //        //Validating if the inputTemp is of the correct datatype
            ...
            //                $"Your value is invalid and rejected. Try again.");
            //        }
            //    }
            //} while (inputTemp.ToUpper() != "X");
